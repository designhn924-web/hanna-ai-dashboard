    ...
    <div className="flex flex-col gap-6">
      <dl className="flex flex-col gap-4 text-sm">
        ...
        <div>
          ...
          <dd className="mt-1 text-stone-800">{customer.phone}</dd>
        </div>
        <div>
          <dt className="text-stone-400">メールアドレス</dt>
          <dd className="mt-1 text-stone-800">{customer.email}</dd>
        </div>
        <div>
          <dt className="text-stone-400">会員ランク</dt>
          <dd className="mt-1 text-stone-800">{customer.rank}</dd>
        </div>
        <div>
      ...
      <div>
        <p className="text-stone-400 text-sm">施術履歴</p>
      ...
      <div>
        <p className="text-stone-400 text-sm">メモ</p>
        <p className="mt-2 text-sm text-stone-700">{customer.memo}</p>
      </div>
    </div>
  );
}
